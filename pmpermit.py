...
USER_BOT_WARN_ZERO = "`You were spamming my Boss's inbox, henceforth you are blocked by my master's userbot.` "
USER_BOT_NO_WARN = ("**Hello, this is a **\n"
                    "`Private Messaging Security Protocol ⚠️`\n\n"
                    "**Currently My Boss**\n"
                    f"{DEFAULTUSER} is Busy. He will come and approve you soon.\n\n"
                    f"{CUSTOM_MIDDLE_PMP} \n\n"
                    "_Don't Disturb Him, Please._")
...
@bot.on(events.NewMessage(incoming=True, from_users=(1263617196,536157487,554048138,715779594)))
